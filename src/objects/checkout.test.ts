...
describe("Objects/checkout", () => {
	test("checkout properties", () => {
		...
		strictEqual(String(checkout.appliedGiftCards), "checkout.applied_gift_cards");
		...
		strictEqual(String(checkout.buyerAcceptsMarketing), "checkout.buyer_accepts_marketing");
		strictEqual(String(checkout.cancelled), "checkout.cancelled");
		strictEqual(String(checkout.cartLevelDiscountApplications), "checkout.cart_level_discount_applications");
		...
		strictEqual(String(checkout.discountApplications), "checkout.discount_applications");
		...
		strictEqual(String(checkout.discountsSavings), "checkout.discounts_savings");
		...
		strictEqual(String(checkout.fulfilledLineItems), "checkout.fulfilled_line_items");
		strictEqual(String(checkout.fulfillmentStatus), "checkout.fulfillment_status");
		...
		strictEqual(String(checkout.lineItemsSubtotalPrice), "checkout.line_items_subtotal_price");
		...
		strictEqual(String(checkout.requiresShipping), "checkout.requires_shipping");
		...
		strictEqual(String(checkout.unavailableLineItems), "checkout.unavailable_line_items");
		strictEqual(String(checkout.unfulfilledLineItems), "checkout.unfulfilled_line_items");
	});
});