...
describe("Objects/metaobjectDefinition", () => {
	test("metaobjectDefinition properties", () => {
		...
		strictEqual(String(metaobjectDefinition.values), "metaobject_definition.values");
		strictEqual(String(metaobjectDefinition.valuesCount), "metaobject_definition.values_count");
	});
});