...
describe("Objects/collection", () => {
	test("collection properties", () => {
		...
		strictEqual(String(collection.allProductsCount), "collection.all_products_count");
		...
		strictEqual(String(collection.previousProduct), "collection.previous_product");
		...
		strictEqual(String(collection.templateSuffix), "collection.template_suffix");
