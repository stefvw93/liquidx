...
describe("Objects/transaction", () => {
	test("transaction properties", () => {
		...
		strictEqual(String(transaction.buyerPendingPaymentInstructions), "transaction.buyer_pending_payment_instructions");
		strictEqual(String(transaction.buyerPendingPaymentNotice), "transaction.buyer_pending_payment_notice");
		...
		strictEqual(String(transaction.gatewayDisplayName), "transaction.gateway_display_name");
		...
		strictEqual(String(transaction.paymentDetails), "transaction.payment_details");
