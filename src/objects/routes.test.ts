...
describe("Objects/routes", () => {
	test("routes properties", () => {
		...
		strictEqual(
			String(routes.accountAddressesUrl),
		...
		strictEqual(
			String(routes.predictiveSearchUrl),
			"routes.predictive_search_url",
		);
		strictEqual(
			String(routes.productRecommendationsUrl),
		...
		strictEqual(
			String(routes.storefrontLoginUrl),
