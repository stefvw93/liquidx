...
describe("Objects/customerPaymentMethod", () => {
	test("customerPaymentMethod properties", () => {
		...
		strictEqual(String(customerPaymentMethod.paymentInstrumentType), "customer_payment_method.payment_instrument_type");
		strictEqual(String(customerPaymentMethod.token), "customer_payment_method.token");
	});
});