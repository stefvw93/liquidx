...
describe("Objects/lineItem", () => {
	test("lineItem properties", () => {
		...
		strictEqual(String(lineItem.discountAllocations), "line_item.discount_allocations");
		...
		strictEqual(String(lineItem.fulfillmentService), "line_item.fulfillment_service");
		...
		strictEqual(String(lineItem.lineLevelDiscountAllocations), "line_item.line_level_discount_allocations");
		strictEqual(String(lineItem.lineLevelTotalDiscount), "line_item.line_level_total_discount");
		strictEqual(String(lineItem.linePrice), "line_item.line_price");
		strictEqual(String(lineItem.message), "line_item.message");
		strictEqual(String(lineItem.optionsWithValues), "line_item.options_with_values");
		strictEqual(String(lineItem.originalLinePrice), "line_item.original_line_price");
		strictEqual(String(lineItem.originalPrice), "line_item.original_price");
		strictEqual(String(lineItem.parentRelationship), "line_item.parent_relationship");
		...
		strictEqual(String(lineItem.requiresShipping), "line_item.requires_shipping");
		strictEqual(String(lineItem.sellingPlanAllocation), "line_item.selling_plan_allocation");
		strictEqual(String(lineItem.sku), "line_item.sku");
		strictEqual(String(lineItem.successfullyFulfilledQuantity), "line_item.successfully_fulfilled_quantity");
		...
		strictEqual(String(lineItem.unitPriceMeasurement), "line_item.unit_price_measurement");
