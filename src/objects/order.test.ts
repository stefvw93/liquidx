...
describe("Objects/order", () => {
	test("order properties", () => {
		...
		strictEqual(String(order.cartLevelDiscountApplications), "order.cart_level_discount_applications");
		...
		strictEqual(String(order.discountApplications), "order.discount_applications");
		...
		strictEqual(String(order.financialStatusLabel), "order.financial_status_label");
		strictEqual(String(order.fulfillmentStatus), "order.fulfillment_status");
		strictEqual(String(order.fulfillmentStatusLabel), "order.fulfillment_status_label");
		...
		strictEqual(String(order.lineItemsSubtotalPrice), "order.line_items_subtotal_price");
		...
		strictEqual(String(order.totalRefundedAmount), "order.total_refunded_amount");
