...
describe("Objects/company", () => {
	test("company properties", () => {
		...
		strictEqual(String(company.availableLocations), "company.available_locations");
		strictEqual(String(company.availableLocationsCount), "company.available_locations_count");
